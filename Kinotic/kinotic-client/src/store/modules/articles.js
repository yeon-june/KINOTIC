...
export default {
  ...
  getters: {
    ...
    isAuthor: (state) => {
      return state.article.user.username === localStorage.getItem('currentUser')
    },
  ...
  actions: {
    fetchArticles({ commit}) {
      ...
      */
      axios({
        ...
        .then(res => {commit('SET_ARTICLES', JSON.parse(JSON.stringify(res.data))) 
    ...
    fetchArticle({ commit }, articlePk) {
      axios({
        ...
        .then(res => commit('SET_ARTICLE', JSON.parse(JSON.stringify(res.data))))
        .catch(err => {
    ...
    createArticle({ commit, getters }, article) {
      ...
      */
      ...
      axios({
        ...
        .then(res => {
          commit('SET_ARTICLE', JSON.parse(JSON.stringify(res.data)))
          router.push({
            name: 'article',
    ...
    likeArticle({ commit, getters }, articlePk) {
      ...
      */
      ...
      axios({
        ...
        .then(res => {
          commit('SET_ARTICLE_COMMENTS', JSON.parse(JSON.stringify(res.data)))
        })
        .catch(err => console.error(err.response))
    },
