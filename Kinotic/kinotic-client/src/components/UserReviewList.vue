    ...
    <div class="flex flex-col mx-auto justify-between mt-7 px-6 py-5 info-card" >
      <div class="flex justify-between my-1">  
        ...
        <div class="flex mb-3 ml-2 items-baseline">
          <p class="text-lg bc-Bold mr-4 f-5353">{{user}} 최근 리뷰</p>
          <p class="text-xs bc-Bold mr-3 f-5353">리뷰 개수: {{contentsCnt}}</p>
        </div>
...
export default {
  ...
  computed: {
    ...
    contents() {
      return this.profile.reviews_list?.slice(0,5)
    },
    contentsCnt() {
      return this.profile.reviews_list?.length
    },
    user(){
